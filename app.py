        ...
        if data:
            ...
            for i in range(len(mydata)):
                if uname == mydata[i]["userName"]:
                    ...
                    break
            if utype == "Buyer":
                return render_template("Buyer.html", name=uname)
...
def updateMenueForm():
    ...
    utype = session.get("utype")
    if uname != None and utype == "Restaurant Owner":
        return render_template("UpdateMenue.html")
    else:
        return render_template("Login.html", error = "First Login to system with Owner Credientials")
...
def updateMenue():
    try:
        ...
        return render_template("UpdateMenue.html", error=str(e))
...
def showmenues():
    try:
        ...
        if utype == "Restaurant Owner":
            ...
            return render_template("resMenue.html", name=uname, data=data)
            ...
            for j in res.menu:
                if j.itemName == itemname:
                    ...
                    if orig_quantity >= quantity and orig_quantity > 0:
                        ...
                        return render_template('order.html' , error = "This much quantity isn't availible!")
                    a.append(j)
...
def confirmorder():
    try:
        ...
        if uname:
            ...
            # update the TotalIncome and quantities of the respective items in the restaurant
    ...
    try:
        ...
        if uname:
            ...
            if res:
                ...
                orders = Order.objects(items__itemName__in=[item.itemName for item in res.menu])
